  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger
        className="flex rounded-full focus:outline-none focus:ring-0 focus:ring-offset-0"
      >
        <button className="p-1 sm:p-0.5 rounded-full bg-zinc-200 dark:bg-zinc-700 text-zinc-800 dark:text-zinc-200 hover:bg-zinc-300 dark:hover:bg-zinc-600 focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-gray-500 dark:focus:ring-gray-300">
...
<<<<<<< HEAD
            rounded hover:text-neutral-800 hover:bg-gray-100 dark:hover:bg-zinc-600 dark:hover:text-gray-50 cursor-pointer outline-none"
=======
            rounded hover:bg-gray-100 dark:hover:bg-neutral-600 dark:hover:text-gray-50 cursor-pointer outline-none"
>>>>>>> 4dd12a4c6ff8518cf08feb39cc267c1cd9197dc0
          >
...
>>>>>>> 4dd12a4c6ff8518cf08feb39cc267c1cd9197dc0
          ...
          <DropdownMenu.Item
            ...
            className="relative flex select-none items-center px-2 py-2 
            rounded rounded-b-lg hover:bg-red-100 dark:hover:bg-red-500 cursor-pointer outline-none text-red-400 hover:text-red-600 dark:text-red-500 dark:hover:text-red-100"
          >
